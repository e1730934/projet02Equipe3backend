...
ALTER TABLE [dbo].[FPS] DROP CONSTRAINT [UQ__FPS__3AFC0423E0C628CD]
GO
...
GO
ALTER TABLE [dbo].[Personnes]  WITH CHECK ADD  CONSTRAINT [CK_Personnes] CHECK  (([TypePersonne]='Personnage' OR [TypePersonne]=
                                                                                                                 N'Comédien' OR [TypePersonne]=
                                                                                                                                N'Étudiant' OR [TypePersonne]= 'Enseignant'))
GO
